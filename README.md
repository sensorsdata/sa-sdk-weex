...
#### 1. npm 安装 sa-sdk-weex 模块

```sh
npm install sa-sdk-weex
```

### 详细文档请参考：[Android & iOS SDK 在 Weex 中使用说明](https://manual.sensorsdata.cn/sa/latest/weex-109576994.html)
...
## License
[License 协议](https://github.com/sensorsdata/sa-sdk-weex/blob/master/LICENSE)
