...
var _saSdkWeex = __webpack_require__(2);

var _saSdkWeex2 = _interopRequireDefault(_saSdkWeex);
...
Vue.prototype.$sensors = _saSdkWeex2.default;
_saSdkWeex2.default.useRouter(router);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weex_module_web_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weex_module_web_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__weex_module_web_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_plugin_version_js__ = __webpack_require__(4);



const saWeexModule = weex.requireModule('WeexSensorsDataAnalyticsModule');
const apisToExport = ['login', 'logout', 'bind', 'unbind', 'setProfile', 'setOnceProfile', 'incrementProfile', 'appendProfile', 'unsetProfile', 'deleteProfile', 'track', 'setServerUrl', 'identify', 'unRegister', 'clearRegister', 'trackViewScreen', 'trackTimerStart', 'trackTimerEnd', 'clearTrackTimer', 'flush', 'deleteAll', 'trackTimerPause', 'trackTimerResume', 'resetAnonymousId', 'trackAppInstall'];
...
var sensors = {
  ...
  appendProfile: function (name, value) {
    if (Object.prototype.toString.call(value) !== '[object Array]') {
      console.error('appendProfile value must be Array<String>');
      return;
    }
    ...
    callWeexModule('appendProfile', arguments);
  },
  useRouter: useRouter,
  track: function () {
    ...
    return function (event, props) {
      if (isFirstTrack) {
        props = props || {};
        props['$lib_plugin_version'] = ['weex:' + __WEBPACK_IMPORTED_MODULE_1__lib_plugin_version_js__["a" /* default */]];
      }
...
for (var i = 0; i < apisToExport.length; i++) {
  var fname = apisToExport[i];
  if (!sensors[fname]) {
    sensors[fname] = function (fname) {
      return function () {
        callWeexModule(fname, arguments);
      };
    }(fname);
  }
}
      ...
      router.afterEach((to, from, failure) => {
        if (!failure) {
          if (to.matched.length > 0) {
            ...
            var props = props.sa_props ? props.sa_props : props.default && props.default.sa_props ? props.default.sa_props : {};
...
if (weex && weex.config.env.platform === 'Web') {
  const sa = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"sa-sdk-javascript\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/* harmony default export */ __webpack_exports__["a"] = (weexSDKVesion);
...
var _One = __webpack_require__(8);

var _One2 = _interopRequireDefault(_One);

var _Two = __webpack_require__(10);
...
var _Tab3 = __webpack_require__(18);

var _Tab4 = _interopRequireDefault(_Tab3);

var _Tab5 = __webpack_require__(20);
...
var router = exports.router = new _vueRouter2.default({
  routes: [{
    ...
    children: [
    // 子路由规则
    { path: "/tab1", name: 'Tab1', component: _Tab4.default, props: { title: 'Tab1Title', sa_props: { superKey: 'superValue' } } }, { path: "/tab2", name: 'Tab2', component: _Tab6.default }]
  }]
});

// sensors.initSDK({auto_track:SAAutoTrackType.CLICK})
// const sensors = weex.requireModule('sensors')
...
//     console.log(index + "")
//     console.log(to.name + "")
//     console.log(JSON.stringify(to.matched[index].props))
//     var props = to.matched[index].props;
//     console.log(props.default ? 'true' : 'false')
//     var title = props.title ? props.title : props.default && props.default.title ? props.default.title : to.name;
//     console.log('title：' + title)
//     console.log(to.matched[index].props)
// });
// if(!failure){
// console.log(dump_obj(failure))
// console.log(dump_obj(from))
// console.log(from.)
// printObj(to)
...
// console.log(to.matched[index].props))
// }
// console.log(JSON.stringify(to.matched[0].component.props))
// console.log(from.path +" to "+to.path)
// sensors.trackViewScreen(to.fullPath)
// }
// });
/* global Vue */
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/HelloWorld.vue"
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/One.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('text', [_vm._v("One")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Two.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('text', [_vm._v("Two")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Three.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('text', [_vm._v("Three")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Tab.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
  name: 'tab1',
  methods: {
    go_tab1: function go_tab1() {
      this.$router.push('/tab1');
    },
    go_tab2: function go_tab2() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("GoTab1")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.go_tab2
    }
  }, [_vm._v("GoTab2")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.go_back
    }
  }, [_vm._v("GoBack")]), _c('router-view', {
    staticClass: ["message"]
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Tab1.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('text', [_vm._v("Tab1")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Tab2.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', [_c('text', [_vm._v("Tab2")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/components/Home.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
  ...
  methods: {
    replace_two: function replace_two() {
      this.$router.replace('/two');
    },

    push_two: function push_two() {
      this.$router.push('/two');
    },
    go_three: function go_three() {
      this.$router.push({ path: '/three', params: { hello: "WeexTitle" } });
    },
    go_back: function go_back() {
      this.$router.back();
    },
    go_tab: function go_tab() {
      this.$router.replace('/tab');
    },
    clickfun: function clickfun() {
      if (!isBack) {
        isBack = true;
        this.$router.push({ path: '/one/mid/mytitle', params: { hello: "WeexTitle" } });
      } else {
        isBack = false;
        this.$router.push('/');
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("ChangeRouterView")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.replace_two
    }
  }, [_vm._v("replace_two")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.push_two
    }
  }, [_vm._v("push_two")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.go_three
    }
  }, [_vm._v("goThree")]), _c('text', {
    staticClass: ["message"],
    on: {
      "click": _vm.go_back
    }
...
__vue_options__.__file = "/Users/chenru/develop/sensors_work_space/gitlab/sa-sdk-weex/WeexDemo/src/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
  ...
  methods: {
    ...
    track: function track() {
      this.$sensors.track("hello", { hello_props: 'hello world' });
    },
    ...
    unRegister: function unRegister(propName) {
    ...
    setServerUrl: function setServerUrl() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h3', [_vm._v("Weex test")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    staticStyle: {
  ...
  }, [_vm._v("unbind")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.setProfile
    }
  }, [_vm._v("setProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.setOnceProfile
    }
  }, [_vm._v("setOnceProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.incrementProfile
    }
  }, [_vm._v("incrementProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.appendProfile
    }
  }, [_vm._v("appendProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.unsetProfile
    }
  }, [_vm._v("unsetProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.deleteProfile
    }
  }, [_vm._v("deleteProfile")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackViewScreen
    }
  }, [_vm._v("trackViewScreen")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
  ...
  }, [_vm._v("unRegister")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.clearRegister
    }
  }, [_vm._v("clearRegister")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
  ...
  }, [_vm._v("identify")]), _c('text', {
    staticClass: ["message", "fn-btn"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.setServerUrl
    }
  }, [_vm._v("setServerUrl")]), _vm._v("\n\n  app 特有：\n  "), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackTimerStart
    }
  }, [_vm._v("trackTimerStart")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackTimerEnd
    }
  }, [_vm._v("trackTimerEnd")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackTimerPause
    }
  }, [_vm._v("trackTimerPause")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackTimerResume
    }
  }, [_vm._v("trackTimerResume")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.clearTrackTimer
    }
  }, [_vm._v("clearTrackTimer")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
  ...
  }, [_vm._v("deleteAll")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.resetAnonymousId
    }
  }, [_vm._v("resetAnonymousId")]), _c('text', {
    staticClass: ["message", "fn-btn", "btn-bg-green"],
    on: {
      "touchstart": _vm.md,
      "touchend": _vm.mu,
      "click": _vm.trackAppInstall
    }
  }, [_vm._v("trackAppInstall")]), _vm._v("\n\n  web 全埋点元素：\n  "), _c('a', {
    staticStyle: {
      color: "blue"
    },
    attrs: {
